			...
			<div class="box ">
				...
				<div class="box-body">
					<div class="dropzone" id="dropzoneun">
						...
						<div class="dz-message">
							<h3> Klik atau Drop Untuk Mengupload Scan Nilai UN, File harus berexstensi .PDF</h3>
						</div>
			...
			<div class="box ">
				...
				<div class="box-body">
					<div class="dropzone" id="dropzoneijazah_d1_d2_d3">
						...
						<div class="dz-message">
							<h3> Klik atau Drop Untuk Mengupload Scan Ijazah D1 / D2 / D3, File harus berexstensi .PDF</h3>
						</div>
			...
			<div class="box ">
				...
				<div class="box-body">
					<div class="dropzone" id="dropzonetranskrip_nilai_d1_d2_d3">
						...
						<div class="dz-message">
							<h3> Klik atau Drop Untuk Mengupload Scan Transkrip Nilai D1 / D2 / D3, File harus berexstensi .PDF</h3>
						</div>
			...
			<div class="box ">
				...
				<div class="box-body">
					<div class="dropzone" id="dropzonesk_pindah">
						...
						<div class="dz-message">
							<h3> Klik atau Drop Untuk Mengupload Scan Surat Pindah Asli dari Perguruan Tinggi, File harus berexstensi .PDF</h3>
						</div>
			...
			<div class="box ">
				...
				<div class="box-body">
					<div class="dropzone" id="dropzonepersyaratan_lain">
						...
						<div class="dz-message">
							<h3> Klik atau Drop Untuk Mengupload Scan Persyaratan Lain Apabila Diperlukan, File harus berexstensi .PDF</h3>
						</div>
