...
<div class="content-wrapper upload" style="min-height: 705px;">
	<div class="container-full">
		...
		<!-- <div class="row" id="refresh"> -->
			...
			<div class="box ">
				<div class="box-header">
					<h4 class="box-title">Upload Scan Kartu Tanda Penduduk (KTP) <?php if ($tokenktp > 0) {
				...
				<div class="box-body">
					<div class="dropzone" id="dropzonektp">
						...
						<div class="dz-message">
							<h3 onClick="document.location.reload(true)"> Klik atau Drop Untuk Mengupload Scan Tanda Penduduk, File harus berexstensi .PDF</h3>
						</div>
				...
				<div class="box-body">
					...
					<div class="">
						...
						<a href="<?= base_url('deleteakte_kelahiran/'.$tokenakte_kelahiran.'') ?>"
							class="btn btn-primary btn-sm  text-capitalize mt-2 " style="background-color:#4B49AC ;" onclick='window.location.reload(true);'><i
								class="fa fa-trash"></i> Hapus </a>
			...
			<div class="box ">
				...
				<div class="box-body">
					<div class="dropzone" id="dropzoneijazah_s1">
						...
						<div class="dz-message">
							<h3 onClick="document.location.reload(true)"> Klik atau Drop Untuk Mengupload Scan Ijazah S1, File harus berexstensi .PDF</h3>
						</div>
			...
			<div class="box ">
				...
				<div class="box-body">
					<div class="dropzone" id="dropzonetranskrip_nilai_s1">
						...
						<div class="dz-message">
							<h3 onClick="document.location.reload(true)"> Klik atau Drop Untuk Mengupload Scan Transkrip Nilai S1, File harus berexstensi .PDF</h3>
						</div>
