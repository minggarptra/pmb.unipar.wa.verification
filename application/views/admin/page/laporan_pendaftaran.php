...
<div class="box box-default">
	...
	<!-- /.box-header -->
	<div class="box-body">
    <form action="print-laporan-pendaftaran" method="POST" target="blank">
		<div class="row">
...
<script src="<?=base_url()?>assets/admin/jsku/laporanpendaftaran.js"></script>
<script type="text/javascript">
	$(document).ready(function () {
		let tahun = $('#tahun_filter').val();
		let jurusan = $('#jurusan_filter').val();
		let src = '<?=base_url()?>pendaftaran/datalaporanpendaftaran';
		let url;
