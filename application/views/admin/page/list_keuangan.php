...
<div class="box">
	...
	<div class="box-body">
		<div class="table-responsive px-4 pb-3 mt-5" style="border: 0">
			...
			<table id="listkeuangan" class="table  table-hover table-bordered margin-top-10 table-responsive">
				<thead>
					<tr>
                        <th width="25">No.</th>
...
<script src="<?=base_url()?>assets/admin/jsku/listkeuangan.js"></script>
<script type="text/javascript">
	$(document).ready(function () {
			let tahun = $('#tahun_filter').val();
			let jurusan = $('#jurusan_filter').val();
			let src = '<?=base_url()?>pendaftaran/datakeuangan';
			let url;
