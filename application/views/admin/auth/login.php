...
<body class="bg-login">
						...
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="login-separater text-center mb-4"> <span>Login Administrator</span>
										<hr />
									</div>
									<div class="form-body">
	...
	<script src="<?= base_url('assets/') ?>tema/plugins/simplebar/js/simplebar.min.js"></script>
	<script src="<?= base_url('assets/') ?>tema/plugins/metismenu/js/metisMenu.min.js"></script>
	<script src="<?= base_url('assets/') ?>tema/plugins/perfect-scrollbar/js/perfect-scrollbar.js"></script>
	...
	<!--app JS-->
	<script src="<?= base_url('assets/') ?>tema/js/app.js"></script>
    <script>var base_url = '<?php echo base_url() ?>';</script>
	<script src="<?= base_url('assets/js/') ?>authadmin.js"></script>
