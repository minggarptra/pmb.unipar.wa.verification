...
<head>
	...
	<!--plugins-->
	<link href="<?= base_url();  ?>assets/tema/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
	<link href="<?= base_url();  ?>assets/tema/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" />
	<link href="<?= base_url();  ?>assets/tema/plugins/metismenu/css/metisMenu.min.css" rel="stylesheet" />
	<link href="<?= base_url();  ?>assets/tema/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
	<link href="<?= base_url();  ?>assets/tema/plugins/datatable/css/dataTables.bootstrap5.min.css" rel="stylesheet" />
	<link href="<?= base_url();  ?>assets/tema/plugins/highcharts/css/highcharts.css" rel="stylesheet" />
	<!-- loader-->
	...
	<!-- Theme Style CSS -->
	<link rel="stylesheet" href="<?= base_url();  ?>assets/tema/css/dark-theme.css" />
	<link rel="stylesheet" href="<?= base_url();  ?>assets/tema/css/semi-dark.css" />
	<link rel="stylesheet" href="<?= base_url();  ?>assets/tema/css/header-colors.css" />
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="<?= base_url();  ?>assets/upload/images/fav/<?= $setting['favicon']; ?>" class="logo-icon"
						alt="logo icon">
				</div>
				<div>
					<h4 class="logo-text">SPMB Instidla</h4>
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="<?= base_url('master-pendaftaran') ?> "><i class="bx bx-right-arrow-alt"></i>
								Data Akun registrasi</a>
						</li>
						<li> <a href="<?= base_url('pendaftaran') ?> "><i class="bx bx-right-arrow-alt"></i>Data
								Pendaftaran</a>
						</li>
					</ul>
				</li>
