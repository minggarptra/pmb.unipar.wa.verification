	...
	<div class="forny-inner">
		<div class="forny-form text-center">
			...
			<div class="reset-form d-block">
				<form id="formconfirm" class="reset-password-form">
					<h4 class="mb-5">Kirim Email Konfirmasi </h4>
					<p class="mb-10">
						Silahkan ketik email anda, kami akan mengirim link Email Konfirmasi Ulang.
					</p>
