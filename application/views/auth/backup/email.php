...
<head>
	...
	<title>Spmb  Email Confirmation</title>
						...
						<tr style="border-collapse:collapse">
							<td class="es-adaptive" align="center" style="padding:0;Margin:0">
								<table class="es-header-body"
									...
									<tr style="border-collapse:collapse">
										<td style="Margin:0;padding-top:20px;padding-bottom:20px;padding-left:20px;padding-right:20px;background-color:#FFFF"
														...
														<table
															...
															<tr style="border-collapse:collapse">
																<td align="center"
																	...
																	<p
																		style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px">
																		Ada sebuah langkah pendaftaran akun <strong><?= $general['app_name']; ?>  <?= $general['slogan']; ?> </strong> yang harus
																		diselesaikan</p>
																</td>
															</tr>
															<tr style="border-collapse:collapse">
																<td align="center"
																	...
																	<p
																		style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px">
																		Klik Tombol di bawah ini untuk Konfirmasi
																		Pendaftaran Anda ..</p>
																</td>
															</tr>
															<tr style="border-collapse:collapse">
